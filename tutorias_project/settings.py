"""
Django settings for tutorias_project project.
...
ALLOWED_HOSTS = os.getenv("DJANGO_ALLOWED_HOSTS", "localhost,127.0.0.1,horarios-tutorias-8vo.onrender.com").split(",")
...
ROOT_URLCONF = 'tutorias_project.urls'
...
WSGI_APPLICATION = 'tutorias_project.wsgi.application'
